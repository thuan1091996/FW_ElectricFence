...
#ifndef IOTLIB_HAL_HARDWARES_MC36XX_H_
#define IOTLIB_HAL_HARDWARES_MC36XX_H_
...
typedef enum
{
    MC3635_EXT_STAT_1      =   0x00,           /*!<  Extended Status 1                                 */
    MC3635_EXT_STAT_2      =   0x01,           /*!<  Extended Status 2                                 */
    MC3635_XOUT_LSB        =   0x02,           /*!<  XOUT_LSB                                          */
    MC3635_XOUT_MSB        =   0x03,           /*!<  XOUT_MSB                                          */
    MC3635_YOUT_LSB        =   0x04,           /*!<  YOUT_LSB                                          */
    MC3635_YOUT_MSB        =   0x05,           /*!<  YOUT_MSB                                          */
    MC3635_ZOUT_LSB        =   0x06,           /*!<  ZOUT_LSB                                          */
    MC3635_ZOUT_MSB        =   0x07,           /*!<  ZOUT_MSB                                          */
    MC3635_STATUS_1        =   0x08,           /*!<  Status 1                                          */
    MC3635_STATUS_2        =   0x09,           /*!<  Status 2                                          */

    MC3635_FREG_1          =   0x0D,           /*!<  Feature 1                                         */
    MC3635_FREG_2          =   0x0E,           /*!<  Feature 2                                         */
    MC3635_INIT_1          =   0x0F,           /*!<  Initialization Register 1                         */
    MC3635_MODE_C          =   0x10,           /*!<  Mode Control                                      */
    MC3635_RATE_1          =   0x11,           /*!<  Rate 1                                            */
    MC3635_SNIFF_C         =   0x12,           /*!<  Sniff Control                                     */
    MC3635_SNIFFTH_C       =   0x13,           /*!<  Sniff Threshold Control                           */
    MC3635_SNIFFCF_C       =   0x14,           /*!<  Sniff Configuration                               */
    MC3635_RANGE_C         =   0x15,           /*!<  Range Resolution Control                          */
    MC3635_FIFO_C          =   0x16,           /*!<  FIFO Control                                      */
    MC3635_INTR_C          =   0x17,           /*!<  Interrupt Control                                 */

    MC3635_INIT_3          =   0x1A,           /*!<  Initialization Register 3                         */
    MC3635_SCRATCH         =   0x1B,           /*!<  Scratchpad                                        */
    MC3635_PMCR            =   0x1C,           /*!<  Power Mode Control                                */

    MC3635_DMX             =   0x20,           /*!<  Drive Motion X                                    */
    MC3635_DMY             =   0x21,           /*!<  Drive Motion Y                                    */
    MC3635_DMZ             =   0x22,           /*!<  Drive Motion Z                                    */

    MC3635_RESET           =   0x24,           /*!<  Reset                                             */

    MC3635_INIT_2          =   0x28,           /*!<  Initialization Register 2                         */
    MC3635_TRIGC           =   0x29,           /*!<  Trigger Count                                     */
    MC3635_XOFFL           =   0x2A,           /*!<  X-Offset LSB                                      */
    MC3635_XOFFH           =   0x2B,           /*!<  X-Offset MSB                                      */
    MC3635_YOFFL           =   0x2C,           /*!<  Y-Offset LSB                                      */
    MC3635_YOFFH           =   0x2D,           /*!<  Y-Offset MSB                                      */
    MC3635_ZOFFL           =   0x2E,           /*!<  Z-Offset LSB                                      */
    MC3635_ZOFFH           =   0x2F,           /*!<  Z-Offset MSB                                      */
    MC3635_XGAIN           =   0x30,           /*!<  X Gain                                            */
    MC3635_YGAIN           =   0x31,           /*!<  Y Gain                                            */
    MC3635_ZGAIN           =   0x32            /*!<  Z Gain                                            */
...
void RegisterSet(uint8_t Register_U8, uint8_t Data_U8P);
...
static void ReadAxis(uint16_t* x, uint16_t* y, uint16_t* z);
...
#endif /* IOTLIB_HAL_HARDWARES_MC36XX_H_ */
