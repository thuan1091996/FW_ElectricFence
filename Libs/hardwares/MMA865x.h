...
#ifndef SRC_TEMPLATES_HARDWAREABSTRACTLAYER_MMA865X_H_
#define SRC_TEMPLATES_HARDWAREABSTRACTLAYER_MMA865X_H_
#define ACCELEROMETER_MMA8652

/*****************************************************************************************************************/
/*													MACROS DEFINITION											 */
/*****************************************************************************************************************/
#define GPIO_INIT							Accelerometer_HAL_T.ACCEL_GPIO_INT->Initialize
#define GPIO_SetInterrupt					Accelerometer_HAL_T.ACCEL_GPIO_INT->SetInterrupt
#define IQR_Handling						Accelerometer_HAL_T.CORE_SERVICES_T.InterruptHandling
#define GetConfig(X)						Accelerometer_HAL_T.CORE_SERVICES_T.GetConfig(X)


#define mAxisX								Accelerometer_HAL_T.AccelerometerData_T->X_F
#define mAxisY								Accelerometer_HAL_T.AccelerometerData_T->Y_F
#define mAxisZ								Accelerometer_HAL_T.AccelerometerData_T->Z_F


#define cMMA865X_Address				(0x1D << 1)	//!<This is the factory pre-configured I2C address for an MMA8652
#define cMMA865X_Sensibility 			20			// 2 * g

#ifdef ACCELEROMETER_MMA8652
	#define cMMA865X_WHO_AM_I			0x4A
#else
	#define cMMA865X_WHO_AM_I			0x5A
#endif
...
typedef enum
{
   ...
   * CTRL_REG3:
   * 		BIT 7: 	FIFO-GATE
   * 		BIT 6:	WAKE-TRANS		Wake from Transient interrupt
   * 		BIT 5:	WAKE-LNDPRT		Wake from Orientation interrupt
   * 		BIT 4:	WAKE-PULSE		Wake from Pulse interrupt
   * 		BIT 3:	WAKE-FF-MT		Wake from Freefall/Motion interrupt
   * 		BIT 2:	-
   * 		BIT 1:	IPOL			Interrupt polarity
   * 		BIT 0:	PP_OD			Push-Pull_Open-Drain
   */
...
#endif /* SRC_TEMPLATES_HARDWAREABSTRACTLAYER_MMA865X_H_ */
